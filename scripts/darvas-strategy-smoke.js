...
assert('darvas chart handoff opens daily box view', popupText.includes("const STRATEGY_LAB_REVIEW_TIMEFRAME = '1d'") && popupText.includes('visibleCandleCount: STRATEGY_LAB_REVIEW_VISIBLE_CANDLES'));
