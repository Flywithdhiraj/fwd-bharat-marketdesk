...
assert('strategy lab UI includes radar filters and alerts', popupText.includes("activeStrategyLabId === 'radar'") && popupText.includes("['new', 'New Coins']") && popupText.includes("'ema_obv'"));
assert('strategy lab UI includes radar queue and notification toggle', popupText.includes('buildRadarAlertCenter') && popupText.includes('btnRadarNotificationToggle') && popupText.includes('strategyLabRadarNotificationsEnabled'));
...
assert('strategy lab includes quality filters and chart review actions', popupText.includes('buildStrategyQualityBar') && popupText.includes('data-strategy-min-score') && popupText.includes('data-strategy-chart-review') && popupText.includes('buildGenericChartDraft'));
assert('strategy lab includes early opportunity mode', popupText.includes("let activeStrategyLabId = 'early'") && popupText.includes('labEarlyOpportunityRows') && popupText.includes('Early Opportunity') && popupText.includes('Run All Scanners'));
...
assert('quick chart review keeps compact controls', chartWorkspaceText.includes('QUICK VIEW |') && chartWorkspaceText.includes('buildQuickReviewControls') && chartWorkspaceText.includes('data-ds-chart-all-candles="1"') && chartWorkspaceText.includes("tfButton('4h', '4H')") && chartWorkspaceText.includes("navButton('zoom-out'") && chartWorkspaceText.includes('ds-chart-review-close-slot') && chartWorkspaceText.includes('!isReview && !isJournalMode && isAdvancedSurface && state.symbol'));
