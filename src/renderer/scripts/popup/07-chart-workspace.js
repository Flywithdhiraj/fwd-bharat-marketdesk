...
function buildTradeReadPanel(intelligence = null, state = {}) {
 ...
 const leg = item => item
  ...
  : '';
 return `<section class="ds-spread-trade-panel ${escapeHtml(tone)}">
 <header>
 <div><span>Calendar Spread</span><strong>${escapeHtml(action.replace('_', ' '))}</strong><em>${escapeHtml(decision.reason || 'No valid setup is confirmed.')}</em></div>
