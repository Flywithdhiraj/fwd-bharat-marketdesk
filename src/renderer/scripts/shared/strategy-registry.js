...
(function initStrategyRegistry(global) {
 ...
 canLiveTrade: false,
  ...
  reversal: Object.freeze({
   ...
   mode: STRATEGY_MODES.SCANNER_ONLY,
   market: 'NSE/BSE F&O stocks',
   timeframe: '4H stretch + 1D context',
  ...
  pullback: Object.freeze({
   ...
   shortName: 'Pullback',
   description: 'Scanner-only trend pullback lab for daily 9 EMA setup, 4H entry timing, market-regime fit, candle quality proof, and late-entry rejection.',
   mode: STRATEGY_MODES.SCANNER_ONLY,
   market: 'NSE/BSE F&O stocks',
   timeframe: '1D trend + 4H timing',
